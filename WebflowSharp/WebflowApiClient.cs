...
{
    public class WebflowApiClient : IWebflowApiClient
    {
        public string ApiToken { get; }
        public static string ApiBase => "https://api.close.com/api";
        string IWebflowApiClient.ApiBase => ApiBase;
        public HttpClient HttpClient { get; }
        
        
        public SiteService Sites => new(this);
        public CollectionService Collections => new(this);
        public ItemService Items => new(this);
        

        /// <summary>
        /// Creates a new instance of <see cref="WebflowApiClient" />.
        /// </summary>
        /// <param name="apiToken">access token</param>'
        public WebflowApiClient(string apiToken)
        {
            ApiToken = apiToken;
        }
