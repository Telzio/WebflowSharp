...
namespace WebflowSharp.Services.Items
{
    public class ItemService : Service
    {
        public override string BasePath => "/collections/{collectionId}/items";
        
        public ItemService() : base(null)
        {
        }
        
        public ItemService(IWebflowApiClient client) : base(client)
        {
        }
