namespace WebflowSharp.Services.Collections
{
    public class CollectionService : Service
    {
        public override string BasePath => "/sites/{siteId}/collections";
        
        public CollectionService() : base(null)
        {
        }
        
        public CollectionService(IWebflowApiClient client) : base(client)
        {
        }
